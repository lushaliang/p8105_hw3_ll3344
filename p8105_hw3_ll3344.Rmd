...
accel_df %>%
  ...
  geom_smooth()
```
The patient has little activity between the minute 0 to about 400. This corresponds to the hours between midnight and 7am, during which time he is probably sleeping. His most active periods during the week appear to be Sunday mornings and Friday evenings. 
