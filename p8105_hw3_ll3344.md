...
![](p8105_hw3_ll3344_files/figure-gfm/aisles_plot-1.png)<!-- --> The
...
![](p8105_hw3_ll3344_files/figure-gfm/plot_activity-1.png)<!-- --> The
patient has little activity between minutes 0 to about 400. This
...
noaa_df %>%
  ...
  ggtitle("Average maximum temperature across NY stations from 1981-2010 in January and July")
```

    ## `summarise()` regrouping output by 'id', 'year' (override with `.groups` argument)

![](p8105_hw3_ll3344_files/figure-gfm/plot_tmax-1.png)<!-- --> The plot
shows that as expected the maximum temperature in July is about 30
degrees Celsius higher than in January in NY. There is no clear trend
over time. There are two notable outliers in January 1982 and 1996 with
markedly lower temperatures. There is also an outlier in July 1988 which
also appeared to have a markedly lower temperature than would be
expected.
