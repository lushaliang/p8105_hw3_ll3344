...
![](p8105_hw3_ll3344_files/figure-gfm/unnamed-chunk-4-1.png)<!-- --> The
...
``` r
accel_df %>%
  group_by(day, day_id, week) %>%
  summarize(total_activity = sum(activity)) %>%
  knitr::kable()
```

    ## `summarise()` regrouping output by 'day', 'day_id' (override with `.groups` argument)

| day       | day\_id | week | total\_activity |
| :-------- | ------: | ---: | --------------: |
| Monday    |       2 |    1 |        78828.07 |
| Monday    |       9 |    2 |       295431.00 |
| Monday    |      16 |    3 |       685910.00 |
| Monday    |      23 |    4 |       409450.00 |
| Monday    |      30 |    5 |       389080.00 |
| Tuesday   |       6 |    1 |       307094.24 |
| Tuesday   |      13 |    2 |       423245.00 |
| Tuesday   |      20 |    3 |       381507.00 |
| Tuesday   |      27 |    4 |       319568.00 |
| Tuesday   |      34 |    5 |       367824.00 |
| Wednesday |       7 |    1 |       340115.01 |
| Wednesday |      14 |    2 |       440962.00 |
| Wednesday |      21 |    3 |       468869.00 |
| Wednesday |      28 |    4 |       434460.00 |
| Wednesday |      35 |    5 |       445366.00 |
| Thursday  |       5 |    1 |       355923.64 |
| Thursday  |      12 |    2 |       474048.00 |
| Thursday  |      19 |    3 |       371230.00 |
| Thursday  |      26 |    4 |       340291.00 |
| Thursday  |      33 |    5 |       549658.00 |
| Friday    |       1 |    1 |       480542.62 |
| Friday    |       8 |    2 |       568839.00 |
| Friday    |      15 |    3 |       467420.00 |
| Friday    |      22 |    4 |       154049.00 |
| Friday    |      29 |    5 |       620860.00 |
| Saturday  |       3 |    1 |       376254.00 |
| Saturday  |      10 |    2 |       607175.00 |
| Saturday  |      17 |    3 |       382928.00 |
| Saturday  |      24 |    4 |         1440.00 |
| Saturday  |      31 |    5 |         1440.00 |
| Sunday    |       4 |    1 |       631105.00 |
| Sunday    |      11 |    2 |       422018.00 |
| Sunday    |      18 |    3 |       467052.00 |
| Sunday    |      25 |    4 |       260617.00 |
| Sunday    |      32 |    5 |       138421.00 |
...
![](p8105_hw3_ll3344_files/figure-gfm/unnamed-chunk-10-1.png)<!-- -->
The patient has little activity between minutes 0 to about 400. This
corresponds to the hours between midnight and 7am, during which time he
is probably sleeping. His most active periods during the week appear to
be Sunday mornings and Friday evenings.
...
```
  ...
  - Essentially for each day from January 1, 1981-December 31, 2010 the
    ...
    Celsius.
  - Since each station only collects a subset of this dat, the resulting
    dataset does contain a significant amount of missing data shown in
    the below table by column/variable.
...
each station across years. Is there any observable / interpretable
...
noaa_df %>%
  ...
  ggplot(aes(x = id, y = mean_max, color = year)) +
  geom_point() +
  facet_grid(~month) +
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))
```
...
![](p8105_hw3_ll3344_files/figure-gfm/unnamed-chunk-15-1.png)<!-- -->
...
![](p8105_hw3_ll3344_files/figure-gfm/unnamed-chunk-16-1.png)<!-- -->
